...
if(isset($_POST['submit'])){
    ...
    if(empty($errors)) {
        ...
        if ($results === false || $results->num_rows === 0) {
            $session->msg("d", "No sales found for the selected dates.");
        ...
        <table class="table table-border">
            ...
            <tbody>
                ...
                while ($result = $results->fetch_assoc()): 
                    $total_sale = $result['total_saleing_price'];
                    $total_buying = $result['total_buying_price'];
                    $profit = $total_sale - $total_buying;
                ...
                ?>
                    <tr>
                        ...
                        <td class="text-right">$<?php echo number_format($total_sale, 2); ?></td>
                    </tr>
                <?php endwhile; ?>
            </tbody>
            <tfoot>
